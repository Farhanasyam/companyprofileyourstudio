        ...
        <div class="row align-items-center min-vh-50">
            <div class="col-lg-8 mx-auto text-center" style="color: var(--dark-brown);">
                <div class="hero-content">
                    <h1 class="display-3 fw-bold mb-4 animate-fade-in">Hubungi Kami</h1>
                    <p class="lead fs-4 mb-5 animate-fade-in-delay">Kami siap membantu Anda dengan pertanyaan dan kebutuhan produk terbaik</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-8">
                <div class="contact-form-card">
                    <div class="card-header-custom">
                        ...
                        <p class="text-muted mb-0">Isi form di bawah ini dan kami akan merespons secepatnya</p>
                    </div>
                    ...
                    <div class="card-body-custom">
                        ...
                        <div class="contact-info-item">
                            ...
                            <div class="info-content">
                                ...
                                <p class="text-muted mb-0">
                                    {{ \App\Models\Setting::get('company_operating_hours', 'Senin - Jumat: 08:00 - 17:00') }}
                                </p>
                            </div>
                        </div>
                    </div>
...
<section class="py-5 bg-white">
    <div class="container">
        <div class="text-center mb-5">
            ...
            <p class="lead text-muted">Kunjungi toko kami untuk melihat produk secara langsung</p>
        </div>
                        ...
                        <div class="address-info">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="address-details">
                                    ...
                                    <p class="text-muted mb-0">{{ \App\Models\Setting::get('maps_address') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
